...
- Validated `v0.1.0-alpha.5` GitHub Release with macOS and Windows zip artifacts.
...
Download the `v0.1.0-alpha.5` macOS and Windows artifacts, smoke-test GUI launch/export on real machines, then tighten ffmpeg onboarding, signing/notarization, and GUI regression coverage before calling SubLight beta-ready.
